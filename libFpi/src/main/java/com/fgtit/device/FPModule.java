...
public class FPModule {
    ...
    private int m_ImageOrientation = 0;
    ...
    //k62v1_64_bsp
    public String Dev_Board = android.os.Build.BOARD;
    ...
    public void FPSetDri1(){
        serialModule.FP_SetDri1();
    }

    public void FPSetDri2(){
        serialModule.FP_SetDri2();
    }

    public void FPSetDri3(){
        serialModule.FP_SetDri3();
    }

    public void FPSetDri4(){
        serialModule.FP_SetDri4();
    }

    public void FPGetDri(){
        serialModule.FP_GetDri();
    }
    ...
    public int getDeviceType() {
        ...
        if(devname.equals("FP09")){
            return Constants.DEV_HB_SPI;
        }
        //8'inch
        if (devname.equals("FP08") || devname.equals("FP-08") || devname.equals("FP-08T") || devname.equals("TIQ-805Q")) {
            if (devname.equals("FP-08T")) {
                ...
                //8 inch, Android 11 ,SPI
            } else if (Dev_Board.equals("k62v1_64_bsp")){
                return Constants.DEV_HB_SPI;
            }
        ...
        //7'inch
        if (devname.equals("b82") || devname.equals("FP07") || devname.equals("FP-07") ||devname.equals("US828")) {
        ...
        //POS device FP09
        if (devname.equals("FP09")) {
            return Constants.DEV_5_4G_UART_POS;
        }

        //人脸机等其他设备外接USB模块
        if(devname.equals("rk3288")){
            return Constants.DEV_8_WIFI_USB;
        }
    ...
    public String getUartName(int devType) {
        ...
        if( android.os.Build.MODEL.equals("FP09")){
            return "/dev/spidev2.0";
        }
        switch (devType) {
            case Constants.DEV_5_3G_UART_A4:
                return "/dev/ttyMT1";
    ...
    public int getUartBaudRate(int devType) {
        ...
        if (Constants.DEV_7_3G_SPI == devType) {
            return 2000 * 1000;
        } else if (Constants.DEV_HB_SPI == devType){
            //return 4000 * 1000;
            return 6*1000*1000;
        }else {
            return 460800;
    ...
    public void GPIO_PowerControl(int IO_No ,boolean bOn) {
        //hibory:172
        GpioControl ca = new GpioControl();
        if (bOn) {
            ca.setGpioMode(IO_No, 0);
            ca.setGpioDir(IO_No, 1);
            ca.setGpioOut(IO_No, 1);
        } else {
            ca.setGpioMode(IO_No, 0);
            ca.setGpioDir(IO_No, 1);
            ca.setGpioOut(IO_No, 0);
        }
    }
    ...
    public boolean PowerControl(boolean bOn) {
        switch (mDeviceType) {
            ...
            return true;
            case Constants.DEV_7_3G_SPI: {
                /*if (Dev_Board.equals("k62v1_64_bsp")){
                    GpioControl ca = new GpioControl();
                    if (bOn) {
    ...
    public void SetImageOrientation(int imageOrientation) {
        this.m_ImageOrientation = imageOrientation;
    }
